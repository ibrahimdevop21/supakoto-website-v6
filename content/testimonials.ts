 ...
 * V2 attributions).
 *
 * Rules (Ibrahim, 2026-08-19): nothing invented, nothing "improved", and
 * NOTHING TRANSLATED — a review stays in the language the customer wrote
 * it, on both locales (`lang` drives the card's dir, not the page locale).
 * Mixed languages in one carousel is the point: two real markets.
 *
 ...
 *
 * The VISIBLE aggregate (★ + count) does NOT come from this file — it is
 * the count-weighted Google rating across the branch listings in
 * content/branches.ts (`reviews`). See components/sections/Testimonials.tsx.
 */
...
export type Testimonial = {
  ...
  /** V2 carried no dates. */
  date?: string;
  /** The language the customer wrote in — rendered as-is on both locales. */
  lang: "ar" | "en";
  text: string;
...
export const testimonials: Testimonial[] = [
  {
    ...
    lang: "ar",
    source: "v2-site",
    text: "السلام عليكم انصح فيه بقوه من توصل لين تستلم سيارتك الشغل والمعامله ممتازه وأسعارهم بالمتناول شكرا أستاذ عمر و شريف ومش قصور بالباقي اخترت ٥٠٪؜ عزل الحراره ممتاز وواضح من الداخل",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    lang: "en",
    source: "v2-site",
    text: "I had a great experience with Supa Koto, they made my Avatr look fantastic. Highly recommended. Special thanks to Mr. Sherif and all the staff.",
  },
  {
    id: 5,
    name: "Hassan Adam",
    ...
    lang: "en",
    source: "v2-site",
    text: "Very professional and great work. Also good after sale follow up — highly recommend.",
  },
  {
    id: 6,
    name: "Engy Ibrahim",
    ...
    lang: "en",
    source: "v2-site",
    text: "Original 100% and after sales service is perfect with annual check ups and maintenance 👌",
  },
  {
    id: 7,
    name: "mohamed fishar",
    ...
    lang: "ar",
    source: "v2-site",
    text: "شركة ممتازة والاسعار أقل بكتير من الشركات الأخرى وفريق العمل متمكن وأعلى كفاءة وجودة وسرعة. أنصح بالتعامل معهم.",
  ...
  },
  {
    ...
    lang: "en",
    source: "v2-site",
    text: "Had a great experience and a great service with the place and with Hesham. The details and the service are brilliant.",
  },
  {
    id: 9,
  ...
  },
  {
    ...
    lang: "ar",
    source: "v2-site",
    text: "انا سعيد بتجربتي مع سوباكوتو … ان شاءالله تتكرر في السيارات القادمة … مستوى عالي من الاحترافية والمهنية في التعامل و الدقة في المواعيد والاسعار مناسبة جدا وكذلك المصداقية في المنتج من خلال التاكيد على انه اصلي بالسريال من الشركة المصنعة و كذلك المتابعة وخدمة ما بعد البيع …. كل شئ كان ممتازت",
  },
  {
    id: 11,
    name: "Ahmed Ali",
    ...
    lang: "en",
    source: "v2-site",
    text: "I recently had a protection Film for 2 Cars in New Cairo Branch.They really have an excellent Professional Team and a very good customer service. A very good after sale follow up. I am very satisfied with their provided service. A big thank you to Mr Mohamed - The Branch Manager for handling all the issues.",
  ...
  },
  {
    ...
    lang: "en",
    source: "v2-site",
    text: "Great customer relation management & high quality products and service. Amazing heat isolation as well. Just recieved my car from them after film protection and heat isolation installation with them with 10 years warranty. Hope they continue to offer great quality along the coming years ISA.",
  ...
  },
  {
    ...
    lang: "en",
    source: "v2-site",
    text: "I would like to thank Supa Koto team, specially Mr Mohamed Swelam for warm hospitality and professionalism. I already made almost 7 cars until now since 2022 and they have super after sales service. Highly recommended.",
  },
  {
    id: 21,
    name: "rami ashraf",
  ...
  },
  {
    ...
    lang: "en",
    source: "v2-site",
    text: "Honestly, Supa Koto has become my recommended provider for anyone who is interested in the PPF. The material exceeds expectations. They are taking care of every inch of the car. Thanks, Supa Koto.",
  },
  {
    id: 24,
    name: "Mina Jack",
    ...
    lang: "en",
    source: "v2-site",
    text: "More than excellent whether in car protection or after sale service. Had two major incidents and car is like brand new fully protected. Strongly recommend this place for even higher professionalism.",
  },
  {
    id: 25,
    name: "Hazem Nagy",
    ...
    lang: "en",
    source: "v2-site",
    text: "I had PPF and various other services at this place. They are the real deal, perfect in every way. Special thanks to Mr Mohammed Sweilam and Ms Effat for the wonderful customer experience. The car was done earlier than expected and I have zero comments. Amazing experience.",
  },
  {
    id: 26,
    name: "Mohamed Fadel",
  ...
  },
  {
    ...
    lang: "en",
    source: "v2-site",
    text: "Had a great experience with Supakoto when I installed PPF film on my car. The team was very professional, explained everything clearly, and the quality of the work really shows. The film was applied perfectly — no bubbles, no edges showing, just a super clean finish.",
  },
  {
    id: 28,
    name: "Mariam Saeid",
  ...
  },
  {
    ...
    lang: "en",
    source: "v2-site",
    text: "I was completely impressed with their professionalism and customer service. High quality films are consistently outstanding which clearly appear on my car, exceeding my expectations with their friendly respectable team and nice place easy to reach. All the thanks for the consistent follow up 🙏🏻🙏🏻🙏🏻.",
  },
  {
    id: 30,
    name: "Esraa Ibrahim",
    ...
    lang: "en",
    source: "v2-site",
    text: "I make protection film at Maadi branch and it was a very wise decision. All the staff is very professional, respectful and helpful, specially Mr Tarek. I asked him millions of questions about protection and about my car and he responded gently and tried to help me in every situation when I scratched my car or had any incident. So thank you to all Maadi staff at Maadi branch, really appreciated.",
  },
];

/**
 * Every review, with the ones tagged for `service` first (service pages);
 * no service → harvest order. The carousel shows ALL available reviews
 * (Ibrahim, 2026-08-19) — nothing is held back per page.
 */
export function orderedTestimonials(service?: ServiceId): Testimonial[] {
  if (!service) return testimonials;
  const tagged = testimonials.filter((t) => t.services.includes(service));
  const rest = testimonials.filter((t) => !t.services.includes(service));
  return [...tagged, ...rest];
}
