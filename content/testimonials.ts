...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    text: {
      ...
      ar: "ركبت مؤخرا فيلم حماية كامل (PPF) على سيارتي مازدا CX-60 عند فريق سوباكوتو في دبي، والتجربة كلها أبهرتني. جودة العمل بلا أخطاء — التشطيب متصل بلا فواصل، والاهتمام بالتفاصيل واضح من كل زاوية. شكر خاص لشريف وهشام اللذين ساعداني كثيرا طوال العملية. أنصح بسوباكوتو بشدة لكل من يفكر في تركيب PPF في دبي. خدمة ممتازة من البداية إلى النهاية!",
    },
  },
  {
    id: 3,
  ...
  },
  {
    ...
    text: {
      ...
      ar: "احترافية عالية وعمل رائع. ومتابعة جيدة بعد البيع أيضا — أنصح بهم بشدة.",
    },
  },
  {
    id: 6,
  ...
  },
  {
    ...
    text: {
      ...
      ar: "قمت ببحث استمر شهرا، شمل القراءة عن PPF والخيارات المتاحة لي هنا في دبي. وزرت حتى الشركات الثلاث التي رشحتها للمهمة. قررت التعامل مع سوباكوتو فقط لأن الجودة اليابانية لا تحتاج إلى نقاش، وفوق ذلك حصلت على عرض رمضان الذي كان متاحا. وشمل ذلك أيضا تظليل النوافذ بالكامل. بعد لقائي بالأستاذ هشام اقتنعت أنني لن أخذل. في اليوم الذي استلمت فيه سيارتي لكزس NX350h موديل 2025 من المعرض، قدت مباشرة إلى القوز وسلمت سيارتي للأستاذ هشام. استغرق الأمر نحو أسبوع، لكن النتيجة النهائية كانت جميلة.",
    },
  ...
  },
  {
    ...
    text: {
      ...
      ar: "ركبت مؤخرا فيلم حماية لسيارتين في فرع القاهرة الجديدة. لديهم فعلا فريق محترف ممتاز وخدمة عملاء جيدة جدا. ومتابعة جيدة جدا بعد البيع. أنا راض جدا عن الخدمة التي قدموها. شكر كبير للأستاذ محمد، مدير الفرع، على التعامل مع كل الأمور.",
    },
  ...
  },
  {
    ...
    text: {
      ...
      ar: "ركبت مؤخرا فيلم حماية PPF على سيارتي، وأعجبتني جودة الخدمة والنتيجة النهائية إلى أقصى حد. من البداية إلى النهاية أظهر الفريق احترافية من الطراز الأول، واهتماما بالتفاصيل، ومعرفة عميقة بالمنتج. كانت الاستشارة واضحة ومفيدة — شرحوا خيارات الفيلم المختلفة ومناطق التغطية والفوائد على المدى الطويل، وساعدوني على اختيار الباقة الأنسب لاحتياجاتي. التركيب نفسه كان دقيقا للغاية. وضع الفيلم بسلاسة، بلا فقاعات ولا حواف ظاهرة ولا عيوب. بالكاد تلاحظ وجوده، لكن الحماية واضحة فورا. ما لفت انتباهي حقا هو اعتزاز الفريق بعمله. عاملوا سيارتي بعناية كأنها سيارتهم. وأعجبتني أيضا سرعة الإنجاز وتعليمات المتابعة لضمان تماسك الفيلم بشكل صحيح.",
    },
  },
  {
    id: 13,
    ...
    text: {
      ...
      ar: "ركبت فيلم حماية وحماية داخلية أيضا قبل 3 أشهر. أعجبتني حقا جودة المنتجات واحترافية فريق العمل. النتائج كانت ممتازة. والمميز فعلا هو متابعتهم بعد البيع من وقت لآخر للاطمئنان على الفيلم وإن كانت لدي أي ملاحظات ❤️ باختصار، أنا راضية تماما عن الخدمة وأنصح بهم الجميع بشدة.",
    },
  },
  {
    id: 14,
  ...
  },
  {
    ...
    text: {
      ...
      ar: "إدارة رائعة لعلاقات العملاء ومنتجات وخدمة عالية الجودة. وعزل حراري مذهل أيضا. استلمت سيارتي منهم للتو بعد تركيب فيلم الحماية والعزل الحراري عندهم مع ضمان 10 سنوات. أتمنى أن يستمروا في تقديم الجودة الرائعة في السنوات القادمة إن شاء الله.",
    },
  ...
  },
  {
    ...
    text: {
      ...
      ar: "شكرا سوباكوتو على أفلام الحماية عالية الجودة للسيارة. كانت تجربة رائعة مع منتجاتكم، وأنا ممتن لخدمتكم الممتازة. سوباكوتو هي شركتي المفضلة لأفلام الحماية. منتجاتهم عالية الجودة وأثبتت فعاليتها في حماية السيارات. شكرا على خدمتكم الرائعة. أنصح بشدة بشركة سوباكوتو لأفلام الحماية. استخدمت منتجاتهم لسيارتي وكانت النتائج رائعة. شكرا على منتجاتكم الممتازة.",
    },
  },
  {
    id: 19,
    ...
    text: {
      ...
      ar: "خدمة متميزة ومنتج بجودة عالية في سوباكوتو. حميت سيارتي مؤخرا بفيلم تاكاي ستيل بلس في سوباكوتو، وأعجبتني التجربة كلها إلى أقصى حد. من البداية إلى النهاية أظهر الفريق احترافية وصبرا واهتماما حقيقيا. شكر خاص للأستاذ محمد سويلم الذي بذل جهدا إضافيا وأجاب بصبر عن كل أسئلتي، بل وأراني عملية التركيب كاملة. معرفته وتعامله الودود جعلاني أشعر بالثقة وأعرف كل خطوة. وأود أيضا أن أشيد بالأستاذ رامي، الذي ضمن اهتمامه بالتفاصيل والتزامه بالجودة تسليم السيارة في حالة مثالية. فحص العمل بنفسه أكثر من مرة للتأكد من أن كل شيء بلا عيوب. فيلم تاكاي ستيل بلس نفسه بجودة ممتازة — المظهر مذهل ويمنحني راحة البال بأن سيارتي محمية. أنصح به بشدة لكل من يقدر الخدمة الراقية والمنتجات عالية الجودة والفريق المحترف فعلا!",
    },
  ...
  },
  {
    ...
    text: {
      ...
      ar: "أود أن أشكر فريق سوباكوتو، وخاصة الأستاذ محمد سويلم، على حسن الضيافة والاحترافية. ركبت عندهم نحو 7 سيارات حتى الآن منذ 2022، وخدمة ما بعد البيع لديهم ممتازة. أنصح بهم بشدة.",
    },
  },
  {
    id: 21,
  ...
  },
  {
    ...
    text: {
      ...
      ar: "أود أن أتقدم بخالص الشكر لفريق سوباكوتو بأكمله على خدمتهم الاستثنائية والتزامهم الثابت بمراقبة الجودة. منذ البداية كانت التجربة سلسة واحترافية — حتى في مرحلة البيع الأولى مع إنجي، التي كانت متعاونة جدا وعلى دراية. شكر خاص جدا لسويلم، مدير العمليات، الذي انعكس اهتمامه بالتفاصيل بوضوح في التنفيذ المتميز والاحترافية العامة للفريق. كل من تعاملت معه كان لطيفا ومحترما وتصرف بأعلى درجات الاحترافية. كان العمل مع سوباكوتو ممتعا حقا، وأنصح بهم بشدة لكل من يبحث عن الجودة والموثوقية.",
    },
  },
  {
    id: 23,
    ...
    text: {
      ...
      ar: "بصراحة، أصبحت سوباكوتو الجهة التي أرشحها لكل من يهتم بفيلم الحماية PPF. الخامة تفوق التوقعات. يعتنون بكل شبر في السيارة. شكرا سوباكوتو.",
    },
  },
  {
    id: 24,
    ...
    text: {
      ...
      ar: "أكثر من ممتاز، سواء في حماية السيارة أو في خدمة ما بعد البيع. تعرضت لحادثين كبيرين والسيارة كأنها جديدة تماما ومحمية بالكامل. أنصح بشدة بهذا المكان لاحترافيته العالية.",
    },
  },
  {
    id: 25,
    ...
    text: {
      ...
      ar: "ركبت PPF وخدمات أخرى متنوعة في هذا المكان. هم الاختيار الحقيقي، مثاليون من كل النواحي. شكر خاص للأستاذ محمد سويلم والأستاذة عفت على تجربة العملاء الرائعة. أنجزت السيارة قبل الموعد المتوقع وليست لدي أي ملاحظات. تجربة مذهلة.",
    },
  },
  {
    id: 26,
    ...
    text: {
      ...
      ar: "كانت تجربة مذهلة، والخدمة أكثر من ممتازة بدءا من خدمة العملاء التي قدمت كل التفاصيل المطلوبة وشرحا واضحا. عندما زرت الفرع (التجمع الخامس) كان الفريق متعاونا ومحترما جدا، وقدموا لي الأنسب لسيارتي مع خصم كبير. لديهم متابعة وخدمة ما بعد بيع احترافية جدا. أنصح بهم بشدة.",
    },
  ...
  },
  {
    ...
    text: {
      ...
      ar: "تجربتي مع سوباكوتو كانت رائعة عندما ركبت فيلم PPF على سيارتي. الفريق محترف جدا، شرحوا كل شيء بوضوح، وجودة العمل ظاهرة فعلا. وضع الفيلم بشكل مثالي — بلا فقاعات ولا حواف ظاهرة، مجرد تشطيب نظيف تماما.",
    },
  },
  {
    id: 28,
    ...
    text: {
      ...
      ar: "كانت تجربة مذهلة، والخدمة ممتازة بدءا من خدمة العملاء التي قدمت لي كل التفاصيل اللازمة. وعرضوا علي أيضا الكثير من العروض للاختيار من بينها. عندما زرت الفرع كان الأستاذ طارق متعاونا ومحترما جدا؛ قدم لي الأنسب لسيارتي مع خصم كبير. لديهم خامات عالية الجودة مع تشطيب خبير. أنصح بهم بشدة.",
    },
  ...
  },
  {
    ...
    text: {
      ...
      ar: "أعجبتني تماما احترافيتهم وخدمة العملاء لديهم. الأفلام عالية الجودة متميزة باستمرار، وهذا واضح على سيارتي، وفاقت توقعاتي مع فريقهم الودود المحترم ومكانهم الجميل سهل الوصول. كل الشكر على المتابعة المستمرة 🙏🏻🙏🏻🙏🏻.",
    },
  },
  {
    id: 30,
    ...
    text: {
      ...
      ar: "ركبت فيلم حماية في فرع المعادي وكان قرارا حكيما جدا. كل فريق العمل محترف ومحترم ومتعاون جدا، وخاصة الأستاذ طارق. سألته ملايين الأسئلة عن الحماية وعن سيارتي فأجاب بلطف وحاول مساعدتي في كل موقف عندما خدشت سيارتي أو تعرضت لأي حادث. فشكرا لكل فريق فرع المعادي، أقدر ذلك حقا.",
    },
  },
];
